...
class Tickets extends Component
{
    ...
    public function add()
    {
        ...
        $this->dispatch('notify', ['message' => 'Successfully added a ticket', 'type' => 'success']);
    ...
    public function delete($ticketId)
    {
        ...
        if (! auth()->user()->can('delete', $ticket)) {
            return $this->dispatch('notify', ['message' => 'You cannot delete tickets.', 'type' => 'error']);
        }

        if ($ticket->isFilled()) {
            return $this->dispatch('notify', ['message' => 'Cannot delete a filled ticket, please remove the user first', 'type' => 'error']);
        }
        ...
        $this->dispatch('notify', ['message' => 'Successfully deleted ticket', 'type' => 'success']);
        $this->dispatch('refresh');
    }
    ...
    public function saveTickets()
    {
        ...
        $this->dispatch('notify', ['message' => 'Successfully saved ticket changes', 'type' => 'success']);
