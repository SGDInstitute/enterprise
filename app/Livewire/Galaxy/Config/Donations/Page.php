...
namespace App\Livewire\Galaxy\Config\Donations;
...
class Page extends Component
{
    ...
    public function addOption($type)
    {
        ...
        $this->$type->save();
        $this->dispatch('notify', ['message' => 'Added ' . $this->newPrice, 'type' => 'success']);
        $this->reset('newPrice');
    }
    ...
    public function removeOption($type, $amount)
    {
        ...
        $this->$type->payload = $options;
        $this->$type->save();
        $this->dispatch('notify', ['message' => 'Removed ' . $amount, 'type' => 'success']);
    }
    ...
    public function saveImage()
    {
        ...
        $this->image->save();
        $this->dispatch('notify', ['message' => 'Saved image.', 'type' => 'success']);
        $this->show(false);
    }
    ...
    public function saveTitle()
    {
        ...
        $this->title->save();
        $this->dispatch('notify', ['message' => 'Saved title.', 'type' => 'success']);
        $this->show(false);
    }
