...
namespace App\Livewire\Galaxy\Users;
...
class Show extends Component
{
    ...
    public function deleteUser()
    {
        ...
        $this->dispatch('notify', ['message' => 'You\'ve deleted ' . $this->user->name . '.', 'type' => 'success']);
    ...
    public function markAsVerified()
    {
        ...
        return $this->dispatch('notify', ['message' => 'Marked user as verified.', 'type' => 'success']);
    }
    ...
    public function resendVerification()
    {
        ...
        return $this->dispatch('notify', ['message' => 'Verification email resent.', 'type' => 'success']);
    }
    ...
    public function sendPasswordReset()
    {
        ...
        return $this->dispatch('notify', ['message' => 'Password reset email sent.', 'type' => 'success']);
    }
}
