...
class Profile extends Component
{
    ...
    public function addRole()
    {
        ...
        return $this->dispatch('notify', ['message' => 'Added role.', 'type' => 'success']);
    }
    ...
    public function newPassword()
    {
        ...
        return $this->dispatch('notify', ['message' => 'Saved new password.', 'type' => 'success']);
    }
    ...
    public function removeRole($role)
    {
        ...
        return $this->dispatch('notify', ['message' => 'Removed role.', 'type' => 'success']);
    }
    ...
    public function save()
    {
        ...
        return $this->dispatch('notify', ['message' => 'Saved user.', 'type' => 'success']);
    }
