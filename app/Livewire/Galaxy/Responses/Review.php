...
class Review extends Component
{
    ...
    public function save()
    {
        if ($this->existing) {
            ...
            return $this->dispatch('notify', ['message' => 'Successfully updated.', 'type' => 'success']);
        }
        ...
        $this->dispatch('notify', ['message' => 'Successfully saved review. You can leave this page and come back to edit your responses.', 'type' => 'success']);
    }
