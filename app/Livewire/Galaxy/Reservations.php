...
class Reservations extends Component
{
    ...
    public function comp()
    {
        ...
        $this->dispatch('notify', ['message' => 'Successfully marked ' . count($this->selected) . ' reservations as comped.', 'type' => 'success']);
    ...
    public function markAsPaid()
    {
        ...
        $this->dispatch('refresh');
        $this->dispatch('notify', ['message' => 'Successfully marked ' . count($this->selected) . ' reservations as paid.', 'type' => 'success']);
