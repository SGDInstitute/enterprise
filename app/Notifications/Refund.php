    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->when(
                $this->order->isStripe(),
                fn ($mail) =>
                $mail->line("This is an automatic message to let you know {$this->count} ticket(s) for {$this->order->event->name} have been refunded.
            ...
            ->when(
                ...
                fn ($mail) =>
                $mail->line("Since all tickets for this order have been refunded, we went ahead and deleted the order.")
            );
    }
