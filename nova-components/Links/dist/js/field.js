...
Nova.booting(function (Vue, router) {
    Vue.component('index-links', __webpack_require__(3));
    Vue.component('detail-links', __webpack_require__(6));
    Vue.component('form-links', __webpack_require__(9));
});
        ...
        _vm._l(_vm.value, function(link, id) {
          return _c("div", { staticClass: "mb-2" }, [
            _c("input", {
              ...
              attrs: { id: "icon" + id, type: "text", placeholder: "Icon" },
              domProps: { value: link.icon },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(link, "icon", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
            ...
            _c("input", {
              ...
              staticClass: "w-1/4 form-control form-input form-input-bordered",
              class: _vm.errorClasses,
              attrs: { id: "order" + id, type: "text", placeholder: "Order" },
              domProps: { value: link.order },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(link, "order", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
