...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('question-detail', __webpack_require__(18));
    Vue.component('question-form', __webpack_require__(21));
    Vue.component('choices', __webpack_require__(24));
});
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c(
      ...
      [_c("questions", { attrs: { value: _vm.field.value, detail: "true" } })],
      1
    )
  ])
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        hasOpenedQuestion: function hasOpenedQuestion() {
                ...
                _c(
                  ...
                  [
                    question.question
                      ...
                      : _c("span", [_vm._v("Question " + _vm._s(key + 1))]),
                    _vm._v(" "),
                    question.type
                      ? _c("span", { staticClass: "ml-2 text-sm text-80" }, [
                          _vm._v("(" + _vm._s(question.type) + ")")
                        ])
                      : _vm._e()
                  ]
                ),
      ...
      : _c(
          ...
          [
            _c(
              "draggable",
              {
                attrs: { options: { disabled: _vm.hasOpenedQuestion } },
                on: {
              ...
              _vm._l(_vm.questions, function(question, key) {
                return _c(
                  ...
                  {
                    key: key,
                    staticClass: "question border border-50 overflow-hidden"
                  },
                  [
                    _c(
                      "a",
                      ...
                      [
                        _c(
                          "svg",
                          {
                            staticClass: "handle fill-current mr-4 h-3 w-3",
                            attrs: {
                              viewBox: "0 0 20 20",
                        ...
                        question.type
                          ? _c(
                              "span",
                              { staticClass: "ml-2 text-sm text-80" },
                              [_vm._v("(" + _vm._s(question.type) + ")")]
                            )
                          : _vm._e()
                      ]
                    ...
                    _c(
                      ...
                      [
                        _c("question-form", {
                          model: {
                            value: _vm.questions[key],
                            callback: function($$v) {
                              _vm.$set(_vm.questions, key, $$v)
                            },
                            expression: "questions[key]"
                          }
                        })
                      ],
                      1
            ...
            _c(
              "button",
              {
                staticClass: "mt-4 btn btn-default btn-primary",
                on: {
                  click: function($event) {
                    $event.preventDefault()
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            types: ['list', 'opinion-scale', 'repeat', 'section', 'select', 'textarea', 'text'],
            question: this.value
        };
    },
    ...
    _c("div", { staticClass: "flex" }, [
      ...
      _c("div", { staticClass: "w-1/2 px-8 pb-4" }, [
        _c("input", {
          ...
          attrs: { id: "id", placeholder: "ID", type: "text" },
    ...
    _c("div", { staticClass: "flex" }, [
      ...
      _c("div", { staticClass: "w-1/2 px-8 pb-4" }, [
        _c("input", {
          ...
          staticClass: "w-full form-control form-input form-input-bordered",
          attrs: { id: "question", placeholder: "Question", type: "text" },
          ...
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.question.rules,
              expression: "question.rules"
            }
          ],
          staticClass: "w-full form-control form-input form-input-bordered",
          attrs: { id: "rules", placeholder: "Rules", type: "text" },
          domProps: { value: _vm.question.rules },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.$set(_vm.question, "rules", $event.target.value)
            }
          }
        })
      ])
        ...
        _c("input", {
          ...
          on: {
            input: function($event) {
              ...
              _vm.$set(_vm.question, "description", $event.target.value)
            }
          }
        })
      ])
    ...
    _vm.question.type === "list" || _vm.question.type === "select"
      ? _c(
          ...
          [
            _c("div", { staticClass: "flex" }, [
              ...
              _c("div", { staticClass: "w-1/2 px-8 pb-4" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.question.multiple,
                      expression: "question.multiple"
                    }
                  ],
                  attrs: {
                    id: "multiple",
                  ...
                  domProps: {
                    checked: Array.isArray(_vm.question.multiple)
                      ? _vm._i(_vm.question.multiple, null) > -1
                      : _vm.question.multiple
                  },
                  on: {
                    change: function($event) {
                      var $$a = _vm.question.multiple,
                        $$el = $event.target,
                      ...
                      if (Array.isArray($$a)) {
                        ...
                        _vm.$set(_vm.question, "multiple", $$c)
                      }
                    }
                  }
                })
            ...
            _c("div", { staticClass: "flex" }, [
              ...
              _c("div", { staticClass: "w-1/2 px-8 pb-4" }, [
                _c("input", {
                  ...
                  domProps: {
                    checked: Array.isArray(_vm.question.other)
                      ? _vm._i(_vm.question.other, null) > -1
                      : _vm.question.other
                  },
                  on: {
                    change: function($event) {
                      var $$a = _vm.question.other,
                        $$el = $event.target,
                        $$c = $$el.checked ? true : false
                      if (Array.isArray($$a)) {
                        var $$v = null,
                        ...
                        if ($$el.checked) {
                          $$i < 0 &&
                            _vm.$set(_vm.question, "other", $$a.concat([$$v]))
                        } else {
                          $$i > -1 &&
                            _vm.$set(
                              _vm.question,
              ...
              ? _c("div", { staticClass: "flex" }, [
                  ...
                  _c("div", { staticClass: "w-1/2 px-8 pb-4" }, [
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.question.other_wording,
                          expression: "question.other_wording"
                        }
                      ],
                      staticClass:
                      ...
                      domProps: { value: _vm.question.other_wording },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
            ...
            _c("choices", {
              model: {
                value: _vm.question.choices,
                callback: function($$v) {
                  _vm.$set(_vm.question, "choices", $$v)
                },
                expression: "question.choices"
              }
            })
          ],
          1
...
Component.options.__file = "resources/js/components/Choices.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-92aa9152", Component.options)
  } else {
    hotAPI.reload("data-v-92aa9152", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex" }, [
    _vm._m(0),
    _vm._v(" "),
    _c("div", { staticClass: "w-2/3 px-8 pb-4" }, [
      _c(
        "ul",
        _vm._l(_vm.choices, function(choice, key) {
          return _c("li", [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.choices[key],
                  expression: "choices[key]"
                }
              ],
              staticClass:
                "appearance-none bg-transparent border-none w-full text-80 py-1 px-2 leading-tight",
              attrs: { id: "id" + key, placeholder: "Choice", type: "text" },
              domProps: { value: _vm.choices[key] },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.choices, key, $event.target.value)
                }
              }
            })
          ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-92aa9152", module.exports)
  }
}
