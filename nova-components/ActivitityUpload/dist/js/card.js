...
Nova.booting(function (Vue, router, store) {
  Vue.component('activitity-upload', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    uploadFile: function uploadFile(event) {
      ...
      axios.post("/nova-vendor/activitity-upload/upload", formData, {
        headers: {
          "Content-Type": "multipart/form-data"
        }
      }).then(function () {
        self.busy = false;
        self.message = "File was successfully uploaded and will begin importing.";
...
var render = function() {
  ...
  return _c("card", { staticClass: "p-4 h-full" }, [
    ...
    _c(
      "p",
      {
        ...
        staticClass: "leading-normal mt-2"
      },
