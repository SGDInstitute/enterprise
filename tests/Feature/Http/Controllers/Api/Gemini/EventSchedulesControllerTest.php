...
class EventSchedulesControllerTest extends TestCase
{
    ...
    {
        $mblgtacc = Event::factory()->create(['title' => 'MBLGTACC', 'slug' => 'mblgtacc']);
        Schedule::factory()->create(['event_id' => $mblgtacc->id, 'title' => 'Main Track']);
        Schedule::factory()->create(['event_id' => $mblgtacc->id, 'title' => 'Advisor Track']);
        $musicFest = Event::factory()->create(['title' => 'Music Fest', 'slug' => 'music-fest']);
        Schedule::factory()->create(['event_id' => $musicFest->id, 'title' => 'Festival']);
