...
- If event start/end dates are the same, don't show two dates
...
- Update users profile info through app
...
- Make users searchable for ticket types
...
- Ability to give users discounts
