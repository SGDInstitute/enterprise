<div class="relative z-10 flex flex-shrink-0 h-16 bg-white border-b border-gray-200 shadow dark:bg-gray-900 dark:border-gray-700">
    <button @click.stop="sidebarOpen = true" class="px-4 text-gray-500 border-r border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 md:hidden">
            ...
            <form class="flex w-full md:ml-0" action="#" method="GET">
                ...
                <div class="relative w-full text-gray-400 focus-within:text-gray-600 dark:focus-within:text-gray-300">
                    <div class="absolute inset-y-0 left-0 flex items-center pointer-events-none">
                        <x-heroicon-s-search class="w-5 h-5" x-description="Heroicon name: search" />
                    </div>
