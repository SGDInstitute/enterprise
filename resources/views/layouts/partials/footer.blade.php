<footer id="footer" class="lg:block bg-gray-300 p-16">
    <div class="mx-auto clearfix">
        <div class="lg:flex">
            <div class="lg:w-1/3 pr-8 mb-4">
                <div class="text-gray-600 text-xs mb-4">
                    <p class="mb-2">The Midwest Bisexual Lesbian Gay Transgender Asexual College Conference (MBLGTACC) is America's largest and oldest continuously-running conference for queer and trans+ college students. “MBLGTACC,” “Midwest Bisexual Lesbian Gay Transgender Asexual College Conference,” “Midwest Bisexual Lesbian Gay Transgender Ally College Conference,” and the MBLGTACC logo are trademarks of the Midwest Institute for Sexuality and Gender Diversity, a non-profit 501(c)(3) organization. Our Tax ID is: 81-1788851.</p>
                    <p>
                        <a href="https://sgdinstitute.org/legal-privacy" target="_blank">Legal &amp; Privacy</a> |
                        <a href="mailto:marketing@sgdinstitute.org">Press/Media</a> |
                        <a href="/changelog">@version('compact')</a>
                    </p>

                </div>
                <div class="w-2/3 sm:w-1/3 lg:w-1/2">
                    <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 799.7 156.1">
                        <defs>
                            <style>
                                .cls-1 {
                                    fill: #fff
