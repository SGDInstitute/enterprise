            ...
            <div class="md:flex -mx-4">
                <div class="md:w-1/4 px-4">
                    <div class="nav flex flex-col bg-white rounded shadow" id="sections" role="tablist"
                        ...
                        <a class="nav-link" id="donations-tab" data-toggle="pill" href="#donations" role="tab"
                           aria-controls="donations" aria-selected="false">Donations</a>
                        <a class="nav-link" id="workshops-tab" data-toggle="pill" href="#workshops" role="tab"
                           aria-controls="workshops" aria-selected="false">Workshops</a>
