    ...
    <div class="flex w-full h-screen items-center justify-center">
        <div>
            ...
            <div class="container flex">
                ...
                <a href="/donations/create/mblgtacc" class="w-1/2 h-32 mx-4 bg-white rounded shadow flex items-center justify-center cursor-pointer p-4 hover:-mt-1 hover:bg-gray-200 hover:shadow-lg text-center text-xl leading-normal">
