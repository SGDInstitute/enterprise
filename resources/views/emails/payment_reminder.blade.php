...
We’re excited to have you join us in {{ $order->event->location }} for {{ $order->event->title }}!
You’ve started the registration process, but still need to complete filling out some of your ticket information and complete your payment.
