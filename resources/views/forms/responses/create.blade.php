                ...
                <div class="p-6 bg-white rounded shadow">
                    @if(now() < $form->start)
                        ...
                        <p class="bg-mint-300 border-l-4 border-mint-500 p-4 shadow mb-4 rounded overflow-hidden">
                            Please create an account or login before submitting {{ $form->type === 'workshop' ? 'a workshop proposal' : 'this form' }}.<br> By logging in, you will be able to come back and change your responses later.
                        </p>
