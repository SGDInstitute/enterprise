    ...
    <form wire:submit="login">
        <x-bit.modal.dialog wire:model.live="loginModal" max-width="sm">
            ...
            <x-slot name="footer">
                ...
                <x-bit.button.flat.secondary size="xs" wire:click="$set('loginModal', false)">
                    Close
            ...
            <x-slot name="content">
                <div class="space-y-2">
                    <p class="text-sm text-gray-600 dark:text-gray-200">
                        Forgot your password? No problem. Enter your email address and we'll send you a link to reset
                        your password.
                    </p>
                    ...
                    @if ($sent)
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-200">
                            Follow the instructions in your email to reset your password and log in. Once you do,
                            refresh this page. All of your progress will be saved.
                        </p>
                    @endif
                </div>
            </x-slot>
