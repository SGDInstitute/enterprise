<div x-data="{ tab: @entangle('tab').live }" class="lg:grid lg:grid-cols-12 lg:gap-x-5">
    ...
    <div x-show="tab === 'info'" class="space-y-6 sm:px-6 lg:col-span-10 lg:px-0">
            ...
            <x-ui.card>
                <div class="space-y-6 px-4 py-6 sm:p-6">
                    ...
                    <div x-data="{ type: @entangle('form.type').live }" class="grid grid-cols-2 gap-6">
                        ...
                        <x-form.group
                            x-show="type && type === 'review' || type === 'availability' || type === 'confirmation' || type === 'finalize'"
