            ...
            <x-ui.card>
                <div class="px-4 py-6 space-y-6 sm:p-6">
                    ...
                    <div x-data="{type: @entangle('form.type')}" class="grid grid-cols-2 gap-6">
                        ...
                        <x-form.group x-show="type && type === 'review' || type === 'availability' || type === 'confirmation'" model="form.parent_id" label="Parent Form" type="select" placeholder="Select Parent Form" :options="$forms" />
