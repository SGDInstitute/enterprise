                ...
                <fieldset>
                    <div class="mt-4 space-y-4">
                        <x-bit.input.checkbox
                            id="reservations"
                            name="reservations"
                            wire:model.live="event.settings.reservations"
                            label="Enable reservations"
                            help="This allows a user to not pay right away but reserve tickets to pay another time"
                        />
                        <x-bit.input.checkbox
                            id="volunteer_discounts"
                            name="volunteer_discounts"
                            wire:model.live="event.settings.volunteer_discounts"
                            label="Enable volunteer discounts"
                        />
                        <x-bit.input.checkbox
                            id="presenter_discounts"
                            name="presenter_discounts"
                            type="checkbox"
                            wire:model.live="event.settings.presenter_discounts"
                            label="Enable presenter discounts"
                        />
                        <x-bit.input.checkbox
                            id="demographics"
                            name="demographics"
                            wire:model.live="event.settings.demographics"
                            label="Collect demographics"
                        />
                        <x-bit.input.checkbox
                            id="add_ons"
                            name="add_ons"
                            wire:model.live="event.settings.add_ons"
                            label="Enable Add on options"
                            help="These are extra cost items that can be added to a ticket e.g. meal tickets, t-shirts."
                        />
                        <x-bit.input.checkbox
                            id="bulk"
                            name="bulk"
                            wire:model.live="event.settings.bulk"
                            label="Allow bulk orders"
                        />
                        <x-bit.input.checkbox
                            id="invoices"
                            name="invoices"
                            wire:model.live="event.settings.invoices"
                            label="Enable invoice generation"
                        />
                        <x-bit.input.checkbox
                            id="check_payment"
                            name="check_payment"
                            wire:model.live="event.settings.check_payment"
                            label="Allow pay by check"
                            help="If unchecked the event can only be paid for by credit card."
                        />
                        <x-bit.input.checkbox
                            id="onsite"
                            name="onsite"
                            wire:model.live="event.settings.onsite"
                        ...
                        <x-bit.input.checkbox
                            ...
                            name="livestream"
                            type="checkbox"
                            wire:model.live="event.settings.livestream"
                ...
                <fieldset>
                    <div class="mt-4 space-y-4">
                        <x-bit.input.checkbox
                            id="has_workshops"
                            name="has_workshops"
                            wire:model.live="event.settings.has_workshops"
                            label="Has workshop proposals"
                        />
                        <x-bit.input.checkbox
                            id="has_volunteers"
                            name="has_volunteers"
                            wire:model.live="event.settings.has_volunteers"
                ...
                <fieldset>
                    <div class="mt-4 space-y-4">
                        <x-bit.input.checkbox
                            ...
                            wire:model.live="event.settings.has_sponsorship"
                            label="Has sponsorship packages"
                        />
                        <x-bit.input.checkbox
                            id="has_vendors"
                            name="has_vendors"
                            wire:model.live="event.settings.has_vendors"
                            label="Has vendor tables"
                        />
                        <x-bit.input.checkbox
                            id="has_ads"
                            name="has_ads"
                            wire:model.live="event.settings.has_ads"
                            label="Has program ads"
                        />
                        <x-bit.input.checkbox
                            id="allow_donations"
                            name="allow_donations"
                            wire:model.live="event.settings.allow_donations"
