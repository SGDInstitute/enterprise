<div class="space-y-4">
    ...
    <x-bit.table>
        <x-slot name="head">
            ...
            <x-bit.table.heading
                sortable
                wire:click="sortBy('ticket_id')"
                :direction="$sortField === 'ticket_id' ? $sortDirection : null"
            >
                Ticket ID
            </x-bit.table.heading>
            <x-bit.table.heading
                ...
                :direction="$sortField === 'user_id' ? $sortDirection : null"
            >
                User ID
            </x-bit.table.heading>
            <x-bit.table.heading
            ...
            <x-bit.table.heading
                sortable
                wire:click="sortBy('pronouns')"
                :direction="$sortField === 'pronouns' ? $sortDirection : null"
            >
                Pronouns
            </x-bit.table.heading>
            <x-bit.table.heading
            ...
            <x-bit.table.heading
                sortable
                wire:click="sortBy('printed')"
                :direction="$sortField === 'printed' ? $sortDirection : null"
            >
                Printed
            </x-bit.table.heading>
            <x-bit.table.heading
