                ...
                <div>
                    ...
                    <fieldset>
                        <div class="mt-4 space-y-4">
                            <x-bit.input.checkbox id="reservations" name="reservations" wire:model.live="event.settings.reservations" label="Enable reservations" help="This allows a user to not pay right away but reserve tickets to pay another time" />
                            @if ($event->settings->reservations)
                            <x-bit.input.group class="ml-12" for="reservation-length" label="Reservation Length">
                                <x-bit.input.text type="text" class="mt-1" id="reservation-length" name="reservation-length" wire:model.live="event.settings.reservation_length" label="Reservation Length" />
