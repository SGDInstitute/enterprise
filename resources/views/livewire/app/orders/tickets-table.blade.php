<div>
    ...
    <div class="mt-8 px-4 py-6 lg:w-2/3 lg:ml-auto bg-gray-50 dark:bg-gray-800 shadow dark:border dark:border-gray-700 sm:p-6 lg:p-8">
        <dl class="space-y-4">
        ...
        <div class="mt-6 space-y-3">
            ...
            @endif
            <div class="space-x-1">
                <x-filament::button :href="route('app.orders.show', [$order, 'payment'])" tag="a" size="sm" icon="heroicon-o-arrow-down-tray" outlined>
                    Download Invoice
                </x-filament::button>
