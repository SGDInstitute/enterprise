<x-bit.modal.dialog wire:model="showCheckModal" max-width="lg">
    <x-slot name="title">Pay with Check</x-slot>

    <x-slot name="content">
        <div class="prose dark:prose-light">
            <p>
                Your order total is {{ $subtotal }}. Please download the invoice and mail it and the check to
            ...
            <p>
                ...
                <strong>Order {{ $order->event->order_prefix }}{{ $order->id }}</strong>
            </p>
        </div>
    </x-slot>
    ...
    <x-slot name="footer">
        <div class="space-x-2">
            ...
            <x-bit.button.flat.primary type="submit" wire:click="downloadInvoice">
                Download Invoice
