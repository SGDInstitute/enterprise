...
<div class="flex items-center">
    <input {{ $attributes }} type="radio" class="w-4 h-4 text-green-600 transition duration-150 ease-in-out form-radio {{ $attributes->get('disabled') ? 'opacity-75 cursor-not-allowed' : '' }}">
