...
<div {{ $attributes }}>
    <div class="sm:hidden">
        ...
        <select
            id="tabs"
            name="tabs"
            class="block w-full rounded-md border-gray-300 focus:border-green-500 focus:ring-green-500 dark:border-gray-700"
        >
    ...
    <div class="hidden sm:block">
        <div class="flex items-center justify-between border-b border-gray-200 dark:border-gray-600">
            ...
            <div class="flex space-x-4">
                ...
                @if ($action)
                    <x-bit.button.round.secondary size="sm" :href="$action['href']">
                        {{ $action['label'] }}
