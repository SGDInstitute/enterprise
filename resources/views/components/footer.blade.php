    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 visible-sm">
                <p class="muted credit">&copy {{ "now"|date("Y") }} Midwest Institute for Sexuality and Gender Diversity</p>
        ...
        <div class="hidden-sm" style="font-size: 12px">
            <p class="muted credit"><a href="/backend" class="copyright">&copy;</a> {{ "now"|date("Y") }} Midwest Institute for Sexuality and Gender Diversity</p>
