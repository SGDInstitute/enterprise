            ...
            <form class="col-lg-6" @submit.prevent="login">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-8">
                  ...
                  <span
                    ...
                    v-show="loginForm.errors.has('email')"
                  >{{ loginForm.errors.get('email') }}</span>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-8">
                  ...
                  <span
                    class="invalid-feedback"
                    v-show="loginForm.errors.has('password')"
                  >{{ loginForm.errors.get('password') }}</span>
                </div>
              </div>
            ...
            <form class="col-lg-6" @submit.prevent="register">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-8">
                  <input
                    ...
                    type="text"
                    class="form-control"
                    :class="{'is-invalid': registrationForm.errors.has('name')}"
                    name="name"
                  ...
                  <span
                    class="invalid-feedback"
                    v-show="registrationForm.errors.has('name')"
                  >{{ registrationForm.errors.get('name') }}</span>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-8">
                  <input
                    ...
                    type="email"
                    class="form-control"
                    :class="{'is-invalid': registrationForm.errors.has('email')}"
                    name="email"
                  ...
                  <span
                    class="invalid-feedback"
                    v-show="registrationForm.errors.has('email')"
                  >{{ registrationForm.errors.get('email') }}</span>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-8">
                  ...
                  <span
                    class="invalid-feedback"
                    v-show="registrationForm.errors.has('password')"
                  >{{ registrationForm.errors.get('password') }}</span>
                </div>
              </div>

              <div class="row form-group">
                <label
                  for="register-modal-password-confirm"
                  class="col-md-4 col-form-label"
                >Confirm Password</label>

                <div class="col-md-8">
                  <input
                    id="register-modal-password-confirm"
                    type="password"
                    class="form-control"
                  ...
                  >{{ registrationForm.errors.get('password_confirmation') }}</span>
                </div>
              </div>
