...
return [
    'galaxy' => [
        ...
        ['name' => 'Reservations', 'route' => 'galaxy.reservations', 'icon' => 'heroicon-o-cursor-click', 'roles' => ['institute', 'mblgtacc']],
        ...
        ['name' => 'Emails', 'route' => 'galaxy.config.emails', 'icon' => 'heroicon-o-mail', 'roles' => ['institute']],
    ],
    'app' => [
        'dashboard' => [
